...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BsYz09y3.mjs");
...
var manifest = {
	"45821968e341458822e481328247a6ec4fc3b20a99e1e45f7cd98da984bbfec9": {
		functionName: "createDocumentUpload_createServerFn_handler",
		importer: () => import("./server-fns-BgZfeNyP.mjs")
	},
	"5fa5797ca75334216e44fa1bc9cdb283f0d094c55ce0ea3ab94aa1d4b24ca855": {
		functionName: "deleteStoredDocument_createServerFn_handler",
		importer: () => import("./server-fns-BgZfeNyP.mjs")
	},
	"60d2f2cdc8e55f1a22e53139a0501170cc01bac7e7a9e779988c4d3e31013c61": {
		functionName: "finalizeDocumentUpload_createServerFn_handler",
		importer: () => import("./server-fns-BgZfeNyP.mjs")
	},
	"b932e7c85398a6c9a6e6569017b4ba89174f6f8a00759894f279678ef9aa81b1": {
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CnrI7aVp.mjs"),
		import("./start-k-ZlyFEI.mjs"),
		import("./empty-plugin-adapters-CcCpDHaN.mjs")
	]);
	return {
		routerEntry,
		startEntry,
